...
function cpuJoga(){
   if(jogando){
      ...
      if(verifica == "O"){
         ...
         document.getElementById("dvQuemComeca").innerHTML= "COMPUTADOR VENCEU"
         jogando=false;
      }
    
      if(verifica == ""){
         if(jogo[0][0] != "" && jogo[0][1] != "" && jogo[0][2] != "" && jogo[1][0] != "" && jogo[1][1] != "" && jogo[1][2] != "" && jogo[2][0] != "" && jogo[2][1] != "" && jogo[2][2] != ""){
            document.getElementById("dvQuemComeca").innerHTML= "DEU VELHA!"
            jogando=false;
         }
      }
...
function jogar(p) {
   if ((jogando)&&(quemJoga==0)) {
      ...
      if(verifica == "X"){
            document.getElementById("dvQuemComeca").innerHTML= "JOGADOR VENCEU"
            jogando=false;
         }
         ...
         for(aaa = 0; aaa < 3; aaa++){
            ...
            for(bbb = 0; bbb < 3; bbb++){
               ...
               if(conta == 9){
                  document.getElementById("dvQuemComeca").innerHTML= "VELHA!"
                  jogando=false;
               }
            }
         }
...
function limpar(){
   ...
   document.getElementById("dvQuemComeca").innerHTML = "Clique pra jogar"
}
